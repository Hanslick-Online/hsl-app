    ...
    <xsl:template match="/">
        ...
        <html xmlns="http://www.w3.org/1999/xhtml">
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/datatables/1.11.0/css/dataTables.bootstrap4.min.css"/>            </head>
            ...
            <body class="page">
                ...
                <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/datatables/1.11.0/js/jquery.dataTables.min.js" />
