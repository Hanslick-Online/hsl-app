    ...
    <xsl:template name="image-source">
        <div id="image-source-widget">
            <div class="navBarNavDropdown dropstart">
                <a title="Bildquelle" data-title-de="Bildquelle" data-title-en="Image source" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false" role="button">
                ...
                <ul class="dropdown-menu">
                    <li class="dropdown-item">
                        <span data-lang="de">Bildquelle: </span>
                        <span data-lang="en" hidden="hidden">Image source: </span>
                        <span id="image-source-link">
                            ...
                            <xsl:choose>
                                ...
                                <xsl:otherwise>
                                    <em data-lang="de">Keine Quellenangabe vorhanden.</em>
                                    <em data-lang="en" hidden="hidden">No source information available.</em>
                                </xsl:otherwise>
                            </xsl:choose>
                        </span>
                    </li>
