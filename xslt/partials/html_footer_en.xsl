...
<xsl:stylesheet xmlns="http://www.w3.org/1999/xhtml"
    ...
    <xsl:template match="/" name="html_footer_en">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="flex-md-row mb-4 align-items-center d-flex justify-content-center">
                                    <a href="https://www.plus.ac.at/">
                                        <img class="card-img-right flex-auto d-md-block" src="images/PLUS_Logo.png" alt="Paris Lodron Universiy of Salzburg" style="max-width: 200px; height: auto; margin-top:1em;" title="Paris Lodron University of Salzburg" />
                                    </a>
                                </div>
                            </div>
                        </div>
        ...
        <div id="cookie-overlay">
            <div class="container">
                <div class="cookie-message">This website uses cookies to ensure you get the best experience on our website. <a href="imprint_en.html?lang=en">More info</a>
                    <br/>
                </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('li a.active').removeClass('active'); $('a[href="' + location.pathname.split("/").at(-1) + '"]').addClass('active');
            });
        </script>
