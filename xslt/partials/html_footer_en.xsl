...
<xsl:stylesheet 
    ...
    version="2.0">
    <xsl:template match="/" name="html_footer_en">      
        <!-- ENGLISH version -->
        <div class="wrapper bg-light translate-en" id="wrapper-footer-full">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="flex-md-row mb-4 align-items-center">
                                    <a href="https://www.fwf.ac.at"><img class="card-img-right flex-auto d-md-block" src="images/fwf-logo_var2.png" alt="FWF Der Wissenschaftsfond Logo" style="max-width: 140px; height: auto; margin-top:1em;" title="FWF Der Wissenschaftsfond" /></a>
                            ...
                            <div class="footer-widget col-lg-12 col-md-12 col-sm-12 ml-auto" style="margin-left:0 !important;">
                                ...
                                <div class="row">                         
                                    <div class="custom-html-widget col-12 py-2">   
                                        <label>App: </label>
                                        <a style="margin-left: .5rem;" href="https://doi.org/10.5281/zenodo.8272623"><img src="https://zenodo.org/badge/DOI/10.5281/zenodo.8272623.svg" alt="DOI"/></a>
                                    </div>
                                    <div class="custom-html-widget col-12 py-2">   
                                    ...
                                    <div class="custom-html-widget col-12 py-2">   
                                        ...
                                        <a style="margin-left: .5rem;" href="https://doi.org/10.5281/zenodo.8272601"><img src="https://zenodo.org/badge/DOI/10.5281/zenodo.8272601.svg" alt="DOI"/></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="footer-imprint-bar bg-dark text-light" id="wrapper-footer-secondary" style="text-align:center; padding:0.4rem 0; font-size: 0.9rem;" >
            © Copyright OEAW | <a href="imprint_en.html?lang=en">Impressum/Imprint</a>
        </div>
