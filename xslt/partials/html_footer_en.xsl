...
<xsl:stylesheet 
    ...
    <xsl:template match="/" name="html_footer_en">      
        <!-- ENGLISH version -->
        <div class="wrapper translate-en" id="wrapper-footer-full">
                ...
                <div class="row">
                    ...
                    <div class="footer-widget col-lg-4 col-md-3 col-sm-3">
                        <div class="textwidget custom-html-widget">
                            ...
                            <p>
                                T: +43 1 51581-2200
                                <br/>
                                E: <a href="mailto:acdh-officek@oeaw.ac.at">acdh-office@oeaw.ac.at</a>
                            </p>
                        </div>
                    </div>
                    <div class="footer-widget col-lg-4 col-md-3 col-sm-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="flex-md-row mb-4 align-items-center d-flex justify-content-center">
                                    <a href="https://www.plus.ac.at/"><img class="card-img-right flex-auto d-md-block" src="images/PLUS_Logo.png" alt="Paris Lodron Universiy of Salzburg" style="max-width: 200px; height: auto; margin-top:1em;" title="Paris Lodron University of Salzburg" /></a>
                                    <!--<div class="card-body d-flex flex-column align-items-start">
                                        <p class="card-text mb-auto">Project partner</p>
                                    </div>-->
                                </div>
        ...
        <div id="cookie-overlay">
            <div class="container">
                <div class="cookie-message">This website uses cookies to ensure you get the best experience on our website. <a href="imprint_en.html?lang=en">More info</a><br/></div>  
